...
static inline QByteArray XMLWriter(const QString &cmd,
                                   ...
                                   const QByteArray &arg10 = QByteArray())
{
    qint32 argc = 0;

    if (!arg10.isNull() && !arg9.isNull()
            && !arg8.isNull() && !arg7.isNull()
            && !arg6.isNull() && !arg5.isNull()
            && !arg4.isNull() && !arg3.isNull()
            && !arg2.isNull() && !arg1.isNull())
        argc = 10;
    else if (!arg9.isNull() && !arg8.isNull()
            && !arg7.isNull() && !arg6.isNull()
            && !arg5.isNull() && !arg4.isNull()
            && !arg3.isNull()  && !arg2.isNull()
            && !arg1.isNull())
        argc = 9;
    else if (!arg8.isNull() && !arg7.isNull()
            && !arg6.isNull() && !arg5.isNull()
            && !arg4.isNull() && !arg3.isNull()
            && !arg2.isNull() && !arg1.isNull())
        argc = 8;
    else if (!arg7.isNull() && !arg6.isNull()
            && !arg5.isNull() && !arg4.isNull()
            && !arg3.isNull() && !arg2.isNull()
            && !arg1.isNull())
        argc = 7;
    else if (!arg6.isNull() && !arg5.isNull()
            && !arg4.isNull() && !arg3.isNull()
            && !arg2.isNull() && !arg1.isNull())
        argc = 6;
    else if (!arg5.isNull() && !arg4.isNull()
            && !arg3.isNull() && !arg2.isNull()
            && !arg1.isNull())
        argc = 5;
    else if (!arg4.isNull() && !arg3.isNull()
             && !arg2.isNull() && !arg1.isNull())
        argc = 4;
    else if (!arg3.isNull() && !arg2.isNull()
             && !arg1.isNull())
        argc = 3;
    ...
    if (argc >= 6)
    {
        writer.writeTextElement("arg6", QString(arg6.toBase64()));
    }
    if (argc >= 7)
    {
        writer.writeTextElement("arg7", QString(arg7.toBase64()));
    }
    if (argc >= 8)
    {
        writer.writeTextElement("arg8", QString(arg8.toBase64()));
    }
    if (argc >= 9)
    {
        writer.writeTextElement("arg9", QString(arg9.toBase64()));
    }
    if (argc >= 10)
    {
        writer.writeTextElement("arg10", QString(arg10.toBase64()));
    }
...
static inline bool XMLReader(const QByteArray &xml_data, qint32 *argc, QString *cmd,
                             ...
                             QByteArray *arg6, QByteArray *arg7, QByteArray *arg8, QByteArray *arg9, QByteArray *arg10)
{
    ...
    QByteArray m_arg1, m_arg2, m_arg3, m_arg4, m_arg5, m_arg6, m_arg7, m_arg8, m_arg9, m_arg10;
    ...
    while (!reader.atEnd() && !reader.hasError() && reader.readNextStartElement())
    {
        ...
        case 5:
            m_argc++;
            m_arg6 = QByteArray::fromBase64(reader.readElementText().toLatin1());
            break;
        case 6:
            m_argc++;
            m_arg7 = QByteArray::fromBase64(reader.readElementText().toLatin1());
            break;
        case 7:
            m_argc++;
            m_arg8 = QByteArray::fromBase64(reader.readElementText().toLatin1());
            break;
        case 8:
            m_argc++;
            m_arg9 = QByteArray::fromBase64(reader.readElementText().toLatin1());
            break;
        case 9:
            m_argc++;
            m_arg10 = QByteArray::fromBase64(reader.readElementText().toLatin1());
            break;
        default:
            break;
        }
